...
list(
    ...
    modelsummary(
        .,
        statistic = "conf.int",
        output = "tables_and_figures/2020_proposals_and_pid_models.docx",
...
ggplot2::ggsave(
    ...
    filename = "tables_and_figures/racial_resentment_identity_models.pdf")
